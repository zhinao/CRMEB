                                ...
                                <view :hidden='currentTab != 0' class='list'>
                                        <form @submit="subCash">
                                                ...
                                                <view class='item acea-row row-between-wrapper'>
                                                        ...
                                                        <view class='input'><input type='number' :placeholder='$t(`请填
写卡号`)' placeholder-class='placeholder'
                                                ...
                                                <view class='item acea-row row-between-wrapper'>
                                                        ...
                                                        <view class='input'><input @input='inputNum' :placeholder='$t(`
最低提现金额`)+minPrice'
                                                ...
                                                <view class='tip'>
                                                        {{$t(`说明: 每笔佣金的冻结期为`)}}{{userInfo.broken_day}}{{$t(`
天，到期后可提现`)}}
                                                </view>
...
天，到期后可提现`)}}
                                ...
                                <view :hidden='currentTab != 2' class='list'>
                                        <form @submit="subCash">
                                                <view class='item acea-row row-between-wrapper'>
                                                        <view class='name'>{{$t(`账号`)}}</view>
                                                        <view class='input'><input :placeholder='$t(`请填写您的支付宝账
号`)' placeholder-class='placeholder'
                                                                        name="name"></input></view>
                                                </view>
                                                <view class='item acea-row row-between-wrapper'>
                                                        <view class='name'>{{$t(`提现`)}}</view>
